                                                 ...
                                                 <asp:Repeater ID="rUsers" runat="server" OnItemCommand="rUsers_ItemCommand" >
                                                     ...
                                                     <ItemTemplate>
                                                         <tr>
                                                             ...
                                                             <td>
                                                                 <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge badge-danger" CommandArgument='<%# Eval("UserId") %>' OnClientClick="return confirm('Do you want to delete this User?');" CommandName="delete">
                                                                     <i class="ti-trash"></i>
                                                                 </asp:LinkButton>
                                                             </td>
                                                         </tr>
